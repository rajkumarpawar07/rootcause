...
| **Primary stack** | Claude API + sentence-transformers + scikit-learn / HDBSCAN + React or Streamlit |
...
| Layer | Tool | Why |
|---|---|---|
| LLM calls | Claude API (or GPT-4 / Gemini) | Reasoning extraction and cluster labeling; the organizers explicitly point entrants toward these [6] |
