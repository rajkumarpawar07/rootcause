...
- `POST /api/diagnose` rejects batches under 8 responses with HTTP 422 `{"detail": {"error": "insufficient_responses", "message", "received", "minimum"}}` — a distinct signal from a successful all-unclear run (HTTP 200).
